...
import AdminSection, { AdminProducts, AdminProductsBreadcrumb, AdminAbout, AdminAboutUs, AdminTestimonials, AdminFooter, AdminHeader, AdminCompanyIntro, AdminContact } from './metik/admin-section';
...
export const puckConfig = {
  components: {
    ...
    Footer: {
      ...
      fields: {
        ...
        copyrightText: { type: 'text', label: 'Dòng bản quyền', contentEditable: true }
      },
      defaultProps: {
        logoUrl: 'https://metik.vn/wp-content/uploads/2026/06/logometik.png.webp',
    ...
    Products: {
      ...
      fields: {
        breadcrumbs: {
          ...
          getItemSummary: (item) => item.text || 'Breadcrumb'
        },
        products: {
          type: 'array',
          label: 'Danh sách sản phẩm',
      ...
      defaultProps: {
        breadcrumbs: [{ text: 'TRANG CHỦ' }, { text: 'SẢN PHẨM' }],
        products: [
          { imageUrl: 'https://metik.vn/wp-content/uploads/2026/06/snack-vi-bap.jpg.webp', name: 'Snack vị Bắp' },
          { imageUrl: 'https://metik.vn/wp-content/uploads/2026/06/snack-vi-bbq.jpg.webp', name: 'Snack vị BBQ' },
          { imageUrl: 'https://metik.vn/wp-content/uploads/2026/06/snack-vi-pho-mai.webp', name: 'Snack vị Phô mai' },
      ...
      render: (props) => {
        const breadcrumbsText = props.breadcrumbs ? props.breadcrumbs.map(b => b.text) : [];
        return <AdminProductsBreadcrumb breadcrumbs={breadcrumbsText} products={props.products} />;
      }
    },
  ...
  categoryGroups: [
    ...
    { title: 'Nâng cao', components: ['Header', 'Hero', 'CompanyIntro', 'NewProducts', 'Products', 'About', 'AboutUs', 'Testimonials', 'Contact', 'Footer'] }
  ],
