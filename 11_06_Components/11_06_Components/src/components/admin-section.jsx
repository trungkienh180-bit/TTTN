...
// ==========================================
export const AdminHeader = memo(({ logoUrl, clubName, subName, links = [], showLanguageToggle, scrolledBgColor }) => {
    ...
    <>
      <header ref={headerRef} style={{
        ...
        background: scrolled
          ...
          : 'linear-gradient(180deg, rgba(11, 53, 91, 0.45) 0%, rgba(11, 53, 91, 0.08) 100%)',
